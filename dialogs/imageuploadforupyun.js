...
( function() {
	var imageDialog = function( editor, dialogType ) {
			...
			return {
				title: editor.lang.imageuploadforupyun[ dialogType == 'image' ? 'title' : 'titleButton' ],
				...
				onOk: function() {
					...
					if ( this.imageEditMode ) {
						...
						if ( dialogType == 'image' && imgTagName == 'input' && confirm( editor.lang.imageuploadforupyun.button2Img ) ) { // jshint ignore:line
							// Replace INPUT-> IMG
							imgTagName = 'img';
						...
						else if ( dialogType != 'image' && imgTagName == 'img' && confirm( editor.lang.imageuploadforupyun.img2Button ) ) { // jshint ignore:line
							// Replace IMG -> INPUT
							imgTagName = 'input';
	...
	CKEDITOR.dialog.add( 'imageuploadforupyun', function( editor ) {
		return imageDialog( editor, 'imageuploadforupyun' );
	} );

	CKEDITOR.dialog.add( 'imagebuttonforupyun', function( editor ) {
		return imageDialog( editor, 'imagebuttonforupyun' );
	} );
} )();
