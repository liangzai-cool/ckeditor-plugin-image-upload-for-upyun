...
( function() {
  ...
  var dialogTypeImageuploadforupyun = pluginName;
  var dialogTypeImageuploadforupyunButton = 'imageuploadforupyunbutton';
  var imageDialog = function( editor, dialogType ) {
      ...
      var onImgLoadErrorEvent = function() {
          ...
          // Set Error image.
          var noimage = CKEDITOR.getUrl( CKEDITOR.plugins.get( pluginName ).path + 'images/noimage.png' );
      ...
      var numbering = function( id ) {
        ...
        fileButtonId = numbering( 'fileButton' );

      return {
        title: editor.lang.imageuploadforupyun[ dialogType == dialogTypeImageuploadforupyun ? 'title' : 'titleButton' ],
        ...
        onShow: function() {
          ...
          if ( link ) {
            ...
            // Fill out all fields.
            if ( dialogType == dialogTypeImageuploadforupyun )
        ...
        onOk: function() {
          ...
          if ( this.imageEditMode ) {
            ...
            if ( dialogType == dialogTypeImageuploadforupyun && imgTagName == 'input' && confirm( editor.lang.imageuploadforupyun.button2Img ) ) { // jshint ignore:line
              // Replace INPUT-> IMG
              imgTagName = 'img';
            ...
            else if ( dialogType != dialogTypeImageuploadforupyun && imgTagName == 'img' && confirm( editor.lang.imageuploadforupyun.img2Button ) ) { // jshint ignore:line
              // Replace IMG -> INPUT
              imgTagName = 'input';
        ...
        contents: [ {
          id: 'info',
          label: editor.lang.imageuploadforupyun.infoTab,
          accessKey: 'I',
          elements: [ {
            type: 'vbox',
            padding: 0,
            children: [ {
              ...
              children: [ {
                ...
                validate: CKEDITOR.dialog.validate.notEmpty( editor.lang.imageuploadforupyun.urlMissing )
              },
              {
                type: 'button',
                id: 'browse',
          ...
          },
          {
            id: 'txtAlt',
            type: 'text',
            label: editor.lang.imageuploadforupyun.alt,
            accessKey: 'T',
            'default': '',
            onChange: function() {
            ...
            children: [ {
              ...
              children: [ {
                ...
                },
                {
                  ...
                  html: '<div>' +
                    '<a href="javascript:void(0)" tabindex="-1" title="' + editor.lang.imageuploadforupyun.lockRatio +
                    '" class="cke_btn_locked" id="' + btnLockSizesId + '" role="checkbox"><span class="cke_icon"></span><span class="cke_label">' + editor.lang.imageuploadforupyun.lockRatio + '</span></a>' +
                    '<a href="javascript:void(0)" tabindex="-1" title="' + editor.lang.imageuploadforupyun.resetSize +
                    '" class="cke_btn_reset" id="' + btnResetSizeId + '" role="button"><span class="cke_label">' + editor.lang.imageuploadforupyun.resetSize + '</span></a>' +
                    '</div>'
                } ]
              },
              {
                ...
                children: [ {
                  ...
                  width: '60px',
                  label: editor.lang.imageuploadforupyun.border,
                  'default': '',
                  onKeyUp: function() {
                    updatePreview( this.getDialog() );
                  },
                  ...
                  validate: CKEDITOR.dialog.validate.integer( editor.lang.imageuploadforupyun.validateBorder ),
                  setup: function( type, element ) {
                    if ( type == IMAGE ) {
                      var value,
                ...
                },
                {
                  ...
                  width: '60px',
                  label: editor.lang.imageuploadforupyun.hSpace,
                  'default': '',
                  onKeyUp: function() {
                    updatePreview( this.getDialog() );
                  },
                  ...
                  validate: CKEDITOR.dialog.validate.integer( editor.lang.imageuploadforupyun.validateHSpace ),
                  setup: function( type, element ) {
                    if ( type == IMAGE ) {
                ...
                },
                {
                  ...
                  width: '60px',
                  label: editor.lang.imageuploadforupyun.vSpace,
                  'default': '',
                  onKeyUp: function() {
                    updatePreview( this.getDialog() );
                  },
                  ...
                  validate: CKEDITOR.dialog.validate.integer( editor.lang.imageuploadforupyun.validateVSpace ),
                  setup: function( type, element ) {
                    if ( type == IMAGE ) {
                ...
                },
                {
                  ...
                  items: [
                    ...
                    //  [ editor.lang.imageuploadforupyun.alignAbsBottom , 'absBottom'],
                    //  [ editor.lang.imageuploadforupyun.alignAbsMiddle , 'absMiddle'],
                    //  [ editor.lang.imageuploadforupyun.alignBaseline , 'baseline'],
                    //  [ editor.lang.imageuploadforupyun.alignTextTop , 'text-top'],
                    //  [ editor.lang.imageuploadforupyun.alignBottom , 'bottom'],
                    //  [ editor.lang.imageuploadforupyun.alignMiddle , 'middle'],
                    //  [ editor.lang.imageuploadforupyun.alignTop , 'top']
                  ],
                  onChange: function() {
                    updatePreview( this.getDialog() );
                    commitInternally.call( this, 'advanced:txtdlgGenStyle' );
        ...
        },
        {
          ...
          label: editor.lang.imageuploadforupyun.linkTab,
          padding: 0,
          elements: [ {
            id: 'txtUrl',
            type: 'text',
        ...
        },
        {
          ...
          label: editor.lang.imageuploadforupyun.upload,
          elements: [ {
            type: 'html',
            id: 'fileButton',
  ...
  CKEDITOR.dialog.add( dialogTypeImageuploadforupyun, function( editor ) {
    return imageDialog( editor, dialogTypeImageuploadforupyun );
  } );

  CKEDITOR.dialog.add( dialogTypeImageuploadforupyunButton, function( editor ) {
    return imageDialog( editor, dialogTypeImageuploadforupyunButton );
  } );
} )();
